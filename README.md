...
Current version pinned via `nixpkgs`: 0.32.2.
...
Hints to compile / upload from command line without the`Makefile`: https://arduino.github.io/arduino-cli/0.32/getting-started/ .
