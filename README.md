...
Current version pinned via `nixpkgs`: 0.33.0.
...
Hints to compile / upload from command line without the`Makefile`: https://arduino.github.io/arduino-cli/0.33/getting-started/ .
